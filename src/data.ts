...
export const experiences: Experience[] = [
  {
    ...
    description: [
      ...
      "Monitor and respond to security incidents in real-time using advanced threat detection tools",
      "Establish and maintain security metrics and KPIs for continuous improvement"
    ]
  },
  {
    id: 2,
    ...
    description: [
      ...
      "Orchestrated successful migration of legacy systems to modern infrastructure",
      "Implemented automated backup and disaster recovery solutions",
      "Managed and optimized network infrastructure for 500+ users",
      "Led IT security initiatives including firewall management and access control",
      "Developed and maintained IT documentation and standard operating procedures"
    ]
  },
  {
    id: 3,
    ...
    description: [
      ...
      "Implemented robust backup and recovery solutions",
      "Managed user access controls and security permissions",
      "Provided technical support and troubleshooting for end-users",
      "Collaborated with vendors for hardware and software procurement"
    ]
  }
];
